...
| [Branches](/model/branch.md) and [pull requests](/model/pull-request.md) | `InvalidBranchName`, `ConflictingLineInStep`, `UnknownFrom`, `FromNotOnMain`, `FromOnLaterStep`, `MergeUnknownBranch`, `MergeOnBranch`, `BranchAlreadyMerged`, `MergeConflict`, `PrWithoutBranch`, `PrUnknownBranch`, `PrDuplicate` |
